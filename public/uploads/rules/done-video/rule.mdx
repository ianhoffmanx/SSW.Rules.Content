...
created: 2025-07-22T01:20:07.000Z
createdBy: 'Tiago Araújo [SSW]'
createdByEmail: tiagov8@gmail.com
lastUpdated: 2026-06-02T03:19:23.565Z
...
* iMovie (for Mac)
* [Descript](https://www.descript.com/) - Get an instant transcript. Then edit your video by editing the text
...
<youtubeEmbed url="https://www.youtube.com/embed/mBoSJpRm7gk" description="Video: 🎬 BEST Clipchamp Video Editing Tips and Tricks (14 min)" />
...
<youtubeEmbed url="https://www.youtube.com/embed/xoe9ZOzlfnQ" description="Video: How to Use OBS Studio to Record Screen (Beginner Tutorial) (11 min) " />

<boxEmbed
  style="info"
  body={<>
    **Note:** The Picture in Picture will be permanently embedded in the exported video and cannot be altered later.
    Set your canvas size to 3840 x 1080 and place your camera source and screenshare next to each other.
  </>}
  figurePrefix="none"
  figure=""
/>
...
<youtubeEmbed url="https://www.youtube.com/embed/N2Pc93zK-Vw" description="Video: How to Record Webcam and Game Separately in OBS Studio | Tutorial (10 min)" />
...
<youtubeEmbed url="https://www.youtube.com/embed/vr8WyM12qC8" description="Video: How To Switch Scenes In OBS Easily! (OBS Hotkeys) | Tutorial (4 min)" />
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="bad" figure="Camera is below eye level" src="/uploads/rules/done-video/bad-seth-camera.jpg" />

<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="good" figure="Good framing, lights and background" src="/uploadshttps://github.com/user-attachments/assets/204f8986-5146-4e0c-9c5f-34985728d03d" />
...
* **Environment** - Ensure your app is in a production environment (URL should be [https://northwind365.com](https://northwind365.com) and not [http://localhost:3000](http://localhost:3000))
...
<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="bad" figure="Inbox messages are showing, and reminder has not been cleared" src="/uploads/rules/done-video/bad_example_email.png" />

<imageEmbed alt="Image" size="large" showBorder={false} figurePrefix="good" figure="Email is popped out to hide messages, and reminder has been cleared" src="/uploads/rules/done-video/good_example_email.png" />

## Tip #9: Use clear audio

Check your audio devices for the best quality and make sure your audio is clear and not distracting. E.g. Position the microphone close to your mouth. (see rule - Do you use a mic for better audio for mobile phone recordings?)
...
<youtubeEmbed url="https://www.youtube.com/embed/DnNTaS7lYZY" description="" />
